module.exports = {
    "up": (conn, cb) => {
        conn.query(`
            CREATE TABLE video (id int NOT NULL AUTO_INCREMENT, source text NOT NULL, title varchar(191) NOT NULL, description varchar(191) NOT NULL, thumbnail varchar(191) NOT NULL, PRIMARY KEY (id));
