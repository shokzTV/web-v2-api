module.exports = {
    "up": (conn, cb) => {
        conn.query(`
            ...
            CREATE TABLE \`right\` (id int NOT NULL AUTO_INCREMENT, name  varchar(191) NOT NULL, ident varchar(191) NOT NULL, PRIMARY KEY (id));
            CREATE TABLE user (id int NOT NULL AUTO_INCREMENT, twitch_id int NOT NULL, display_name varchar(191) NOT NULL, avatar varchar(191) NOT NULL, profile_url varchar(191) NOT NULL, custom_title varchar(191) NOT NULL, PRIMARY KEY (id));
            ...
            CREATE TABLE article (id int NOT NULL AUTO_INCREMENT, title varchar(191) NOT NULL, author int NOT NULL, created datetime NOT NULL, cover varchar(191) NOT NULL, body longtext NOT NULL, status enum('draft', 'published', 'hidden') NOT NULL, PRIMARY KEY (id), KEY fkIdx_73 (author), CONSTRAINT FK_73 FOREIGN KEY fkIdx_73 (author) REFERENCES user (id));
            CREATE TABLE media (id integer NOT NULL AUTO_INCREMENT, article_id int NOT NULL, type enum('source', 'video', 'article') NOT NULL, reference varchar(191) NOT NULL, reference_source varchar(191) NOT NULL, PRIMARY KEY (id), KEY fkIdx_50 (article_id), CONSTRAINT FK_50 FOREIGN KEY fkIdx_50 (article_id) REFERENCES article (id));
